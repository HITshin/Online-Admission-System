     ...
     <body style="background-image:url('./images/inbg.jpg');">
        <form id="edform" action="editform.php" method="post">
            <div class="container-fluid">    
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/adminlogin.png" width="100%" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             </div>
            ...
            <table class="frmtbl">
                ...
                <tr border="1" class="hdrow">
                  ...
                  <tr>
                    ...
                    <input type="text" id="uphn2" name="uphn2" value="<?php echo $uphn2  ?>"></td>
                  </tr>
               ...
               <tr>
                     ...
                     <td><select id="col" name="col">
                         ...
                         <option>Lokmanya Tilak College of Engineering</option>
                         <option>Mahatma Gandhi Mission's College of Engineering and Technology
</option>
                         </select>
                     </td>
